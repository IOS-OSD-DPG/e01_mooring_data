...
data_dir = 'E:\\charles\\e01_data_page\\data\\'
...
for inst in ['cur', 'ctd']:
    ...
    inst_df.to_csv(f'.\\data\\e01_{inst}_data.csv', index=False)
    print(f'e01_{inst}_data.csv')

# save list of static pressure files to csv
derived_depth_files.to_csv(f'.\\data\\e01_cur_ctd_derived_depth.csv', index=False)
